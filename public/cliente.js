...
function mostrar(dados){
    ...
    for (let c in dados) {
        lista.innerHTML += "<tr>"
                ...
                + "<td>" + dados [c].nome + "</td>"
                + "<td>" + dados [c].email + "</td>"
                + "<td>" + dados [c].telefone + "</td>"
                + "<td>" + dados [c].endereco + "</td>"
                + "<td>" + new Date(dados [c].data_cadastro).toLocaleString() + "</td>"
                + "<td>"
                + "<button type='button' class='btn btn-primary' onclick='alterar(" + dados [c].id + ")'>Editar</button> "
                + "<button type='button' class='btn btn-danger' onclick='excluir(" + dados [c].id + ")'>Excluir</button>"
                + "</td>"
                + "</tr>";
    }
}